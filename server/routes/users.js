...
router.patch('/profile', protect, async (req, res) => {
  try {
    const allowedFields = ['name', 'bio', 'gender', 'interestedIn', 'dateOfBirth', 'preferences', 'profilePhoto', 'coverPhoto', 'settings'];
    const updates = {};
    ...
    res.json({ success: true, user: user.toSelfProfile() });
  } catch (err) {
